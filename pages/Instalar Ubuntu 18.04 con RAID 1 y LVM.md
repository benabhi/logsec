...
## 
#+BEGIN_WARNING
Esta guia esta basada en la version __18.04__ de ubuntu, puede no ser igual en versiones posteriores.
#+END_WARNING
## Requisitios
...
### 
#+BEGIN_NOTE
Se sobre entiende que luego de cada paso es necesario darle a la opcion ^^Done^^ para continuar el proceso de instalacion.
#+END_NOTE
