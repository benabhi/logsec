...
#### La forma mas fácil de determinar el layout del teclado es confirmar la detección del teclado automática que ofrece el instalador. Para lo cual el sistema nos va ir pidiendo ingresar un conjnto de caracteres para seleccionar una distribucion. (en este caso es **latam**)
#####
