...
## 
#+BEGIN_WARNING
Esta guiá esta basada en la versión **18.04** de ubuntu, puede no ser igual en versiones posteriores. Es necesario utilizar la imagen que tiene el instalador "alternativo" de nombre 
#+END_WARNING
## Requisitios
